...
using SignalRWebUl.Dtos.BookingDtos;
using System.Text;
...
namespace SignalRWebUl.Controllers
{
	public class BookingController : Controller
	{
		...
		{
			var client = _httpClientFactory.CreateClient();
			await client.GetAsync($"https://localhost:7217/api/Booking/BookingStatusApproved/{id}");
			return RedirectToAction("Index");
		}
		...
		{
			var client = _httpClientFactory.CreateClient();
			await client.GetAsync($"https://localhost:7217/api/Booking/BookingStatusCanceled/{id}");
			return RedirectToAction("Index");
		}
	}
}
